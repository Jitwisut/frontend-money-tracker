...
export default function TransactionsPage() {
  ...
  // Export Dropdown State (ใช้ useRef เพื่อความแม่นยำในการปิด)
  ...
  // Close export menu on outside click (ใช้ Logic Ref ที่แม่นยำกว่า)
  useEffect(() => {
  ...
  const fetchTransactions = async (f) => {
    ...
    try {
      ...
      console.error(err);
      // แสดง Error จาก api.js ที่เราเพิ่งแก้
